...
export function Resume(props) {
  const { games, appoinmentDate } = props;
  ...
  const appoinmentDateString = appoinmentDate.toISOString();
  useEffect(() => {
    let totalTemp = 0;

    forEach(games, (game) => {
      const price = game.attributes.price;
